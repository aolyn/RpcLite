...
namespace RpcLite.Config
{
	public class RpcLiteConfigurationHelper
	{
		...
		private static void InitializeClientConfig(IConfiguration section, RpcLiteConfig instance)
		{
			var clientsNode = section.GetSection("clients");
			if (clientsNode != null)
			{
		...
		private static void InitializeResolverConfig(IConfiguration section, RpcLiteConfig instance)
		{
			try
			{
				var resolverNode = section.GetSection("addressResolver");
		...
		private static void InitializeServiceConfig(IConfiguration section, RpcLiteConfig instance)
		{
			try
			{
				var servicesNode = section.GetSection("services");
